...
public class CerebrasInferenceProvider extends _OAICompatibleInferenceProvider {

    public CerebrasInferenceProvider(String id, JsonObject config) {
        super(id, config);
    }
    ...
    public InferenceProviderType type() {
        return InferenceProviderType.CEREBRAS;
    }
