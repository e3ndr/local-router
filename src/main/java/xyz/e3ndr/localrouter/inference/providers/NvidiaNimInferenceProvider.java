...
public class NvidiaNimInferenceProvider extends _OAICompatibleInferenceProvider {

    public NvidiaNimInferenceProvider(String id, JsonObject config) {
        super(id, config);
    }
    ...
    public InferenceProviderType type() {
        return InferenceProviderType.NVIDIA_NIM;
    }
